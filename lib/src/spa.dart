...
double _meanAnomalySun(double jce) => _thirdOrderPolynomial(
    -1 / 300000.0, -0.0001603, 35999.05034, 357.52772, jce);

double _meanAnomalyMoon(double jce) => _thirdOrderPolynomial(
    1 / 56250.0, 0.0086972, 477198.867398, 134.96298, jce);

double _argumentLatitudeMoon(double jce) => _thirdOrderPolynomial(
    1 / 327270.0, -0.0036825, 483202.017538, 93.27191, jce);

double _ascendingLongitudeMoon(double jce) => _thirdOrderPolynomial(
    1 / 450000.0, 0.0020708, -1934.136261, 125.04452, jce);

double _xyTermSummation(
        int i, Tuple5<double, double, double, double, double> x) =>
...
Tuple2<double, double> _nutationLongAndObliquity(
    double jce, Tuple5<double, double, double, double, double> x) {
  var sumPsi = 0.0;
  var sumEps = 0.0;
...
double _sunMeanLongitude(double jme) => _limitDeg(280.4664567 +
    jme *
        (360007.6982779 +
            jme *
                (0.03032028 +
...
double _sunRiseAndSet(double mRts, double hRts, double dtPrime, double latitude,
...
SPAOutput spaCalculate(
  ...
  out.azimuthAstro =
      _topocentricAzimuthAngleAstro(it.hPrime!, params.latitude, it.delPrime!);
